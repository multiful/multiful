...
- **CertFinder**  
  자격증 난이도 분석 및 추천 웹 – 자격증, 관련 직무, 전공 등을 네트워킹으로 연결하고 사용자의 전공, 희망직무, 학년, 취득한 자격증, 관심 자격증 등을 rewriting 후 쿼리에 포함한 RAG기반 자격증 추천 시스템

- **RAG_finance**  
  금융 정책 감독 및 규율 키워드 정리 웹 - 금융 규제·정책 문서를 RSS 크롤링으로 실시간 수집하고, Hybrid Search + RAG, Risk 분석 및 Sandbox 시뮬레이션 기능을 탑재한 시스템
